...
const PhdCandidateDetails = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-blue-900 text-gray-100 p-4 sm:p-8">
      <Head>
        <title>MVSD LAB - {phdCandidateDetails.basicInfo.first_name}'s Profile</title>
      </Head>
      ...
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="bg-gray-800/50 backdrop-blur-lg rounded-3xl p-8 shadow-2xl">
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="relative group w-48 h-48 shrink-0">
              ...
              />
              <div className="absolute inset-0 border-2 border-blue-400/30 rounded-2xl pointer-events-none" />
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* Basic Information */}
          <section className="bg-gray-800/50 backdrop-blur-lg p-8 rounded-2xl shadow-xl">
            ...
            <div className="space-y-4">
              ...
              <InfoItem icon={<FiCalendar />} label="Date of Birth" value={phdCandidateDetails.basicInfo.dob} />
              <InfoItem icon={<FiCalendar />} label="Admission Date" value={phdCandidateDetails.basicInfo.admission_date} />
              <InfoItem icon={<FiCalendar />} label="Completion Date" value={phdCandidateDetails.basicInfo.completion_date} />
          ...
          <div className="fixed inset-0 bg-black/90 backdrop-blur-xl flex items-center justify-center z-50 p-4">
            <div className="relative max-w-4xl w-full">
              <button
                ...
                className="absolute -top-4 -right-4 text-white hover:text-blue-300 z-50 transition-colors"
              >
...
const DocumentCard = ({ title, type, imageUrl, onClick }) => (
  <div 
    className="group relative bg-gray-700 rounded-xl overflow-hidden cursor-pointer transform transition-all hover:-translate-y-2 shadow-lg"
    onClick={onClick}
  >
