...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    img1.src = '/images/background_img_login.jpg';
    img2.src = '/images/login_img.jpg';
  }, []);
    ...
    <div className="bg-cover bg-center min-h-screen flex items-center justify-center text-white" style={{ backgroundImage: "url('/images/background_img_login.jpg')" }}>
      <div className="flex flex-col md:flex-row bg-white/10 backdrop-blur-lg rounded shadow-lg max-w-4xl w-full p-6 md:p-0">
        ...
        <div className="hidden md:block md:w-1/2">
          <img src="/images/login_img.jpg" alt="Login Visual" className="h-full w-full object-cover rounded" />
        </div>
              ...
              <form onSubmit={handleLogin} className="mt-6">
                ...
                <div className="mt-4 flex items-center justify-between">
                  <label className="flex items-center gap-2">
                    ...
                    />
                    <span className="text-xs text-[#012970]">Remember Me</span>
                  </label>
                  <a className="text-sm font-medium text-[#012970] underline text-[#012970]" href="/forgot-password">Forgot Password?</a>
                </div>
