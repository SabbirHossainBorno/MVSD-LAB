    ...
    >
      ...
      <div className={`container mx-auto flex flex-col lg:flex-row gap-12 ${isLoading ? 'opacity-50' : ''}`}>
        ...
        <div className="flex flex-col items-start lg:max-w-md mx-auto">
          ...
          <form onSubmit={handleSubscribe} className="bg-gray-800 p-6 rounded shadow-lg">
            <div className="relative mb-4">
              ...
              <input
                ...
                className="block w-full px-4 py-3 text-lg font-medium shadow-md text-white bg-gray-900 border border-gray-600 rounded placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between border-t border-gray-700 pt-8 mt-12">
          ...
          <Link
            ...
            className="p-1 rounded-lg flex items-center border border-gray-300 justify-center transition-all duration-500 hover:border-gray-200 hover:bg-gray-100 group">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 71 72" fill="none">
                <path
                  className="transition-all duration-300 group-hover:fill-gray-800"
          ...
          <Link href="https://www.mvsdlab.com"
            className="p-1 rounded-lg flex items-center border border-gray-300 justify-center transition-all duration-500 hover:border-gray-200 hover:bg-gray-100 group">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 71 72" fill="none">
              <path
                className="transition-all duration-300 group-hover:fill-gray-800"
