...
import { FiEdit, FiFileText, FiCheckCircle, FiClock, FiXCircle, FiExternalLink } from 'react-icons/fi';
    ...
    const fetchPublication = async () => {
      try {
        ...
        setFormData({
          ...
          authors: Array.isArray(data.publication.authors)
        ...
        router.push('/member_dashboard/list_publication');
      }
    };
  ...
  if (isApproved) {
    return (
      <div className="h-full flex items-center justify-center p-6">
        <div className="text-center p-8 rounded-3xl bg-white/70 text-gray-500 shadow-2xl backdrop-blur-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-2.5 rounded border bg-white border-gray-300 text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-600"
              required
            >
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2 mb-2">
              {formData.authors?.length > 0 ? (
                formData.authors.map((author, index) => (
                  <div key={index} className="flex items-center gap-2 px-3 py-1 rounded text-sm bg-gray-200 text-gray-700">
                    {author}
                    <button
                      type="button"
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-4 py-2.5 rounded border bg-white border-gray-300 text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-600"
                placeholder="Add Author"
              />
              <button
                type="button"
                onClick={addAuthor}
                className="px-4 py-2.5 rounded bg-purple-600 hover:bg-purple-700 text-white"
              >
                Add
              </button>
            </div>
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div className="flex gap-2">
                  <a
                    ...
                    className="px-3 py-1.5 rounded flex items-center gap-2 bg-gray-100 text-blue-600 hover:bg-gray-200"
                  >
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 rounded flex items-center gap-2 bg-gray-100 text-red-600 hover:bg-gray-200"
                  >
            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  className="w-full p-2 rounded border bg-white border-gray-300 text-gray-800 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:bg-gray-200 file:text-gray-700"
                />
                {existingDocument && (
          ...
          <motion.button
            ...
            className={`w-full py-3 rounded font-medium transition-colors bg-purple-600 hover:bg-purple-700 text-white ${
