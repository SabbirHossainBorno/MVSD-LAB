        ...
        <section className="pb-6">
          <div className="max-w-screen-xl mx-auto px-4">
            ...
            <div className="mb-12">
              ...
              <Slider {...settings}>
                {professors.map((prof) => (
                  <div key={prof.id} className="bg-gradient-to-r from-gray-800 via-gray-600 to-gray-400 rounded-lg p-6 shadow-lg mx-auto">
                    ...
                    <div className="mt-6 text-center">
                      <h4 className="text-white text-2xl font-semibold mb-2">{`${prof.first_name} ${prof.last_name}`}</h4>
                      <p className="text-gray-300 text-sm mb-1">{prof.email}</p>
                      <p className="text-gray-300 text-sm mb-1">ID: {prof.id}</p>
                      <p className="text-gray-300 text-sm mb-4">{prof.short_bio}</p>
